...
When creating a new grouping, always use the latest value specified in the [schema](../tests/data_schema.json). It is defined under `version` as `const` in the [schema](../tests/data_schema.json).
